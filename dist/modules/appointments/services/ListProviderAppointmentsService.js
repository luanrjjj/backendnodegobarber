...
let ListProviderAppointmentsService = (_dec = (0, _tsyringe.injectable)(), _dec2 = function (target, key) {
  ...
  async execute({
    ...
    var _this$cacheProvider;

    const cacheKey = `provider-appointments:${provider_id}:${year}-${month}-${day}`;
    let appointments = await ((_this$cacheProvider = this.cacheProvider) === null || _this$cacheProvider === void 0 ? void 0 : _this$cacheProvider.recover('ornitorrinco'));

    if (!appointments) {
      var _this$cacheProvider2;
      ...
      await ((_this$cacheProvider2 = this.cacheProvider) === null || _this$cacheProvider2 === void 0 ? void 0 : _this$cacheProvider2.save(cacheKey, (0, _classTransformer.classToClass)(appointments)));
    }
